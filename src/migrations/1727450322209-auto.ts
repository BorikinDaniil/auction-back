...
export class auto1727450322209 implements MigrationInterface {
    name = 'auto1727450322209'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "subCategories" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "isDeleted" boolean NOT NULL DEFAULT false, "name" character varying NOT NULL, "user_id" integer, CONSTRAINT "UQ_adb1d3d35d733cb2bc640a1fed5" UNIQUE ("name"), CONSTRAINT "PK_d22319d65c44efc1d19c4a08989" PRIMARY KEY ("id"))`);
